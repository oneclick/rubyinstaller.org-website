...
If you don't know what version to install and you're getting started with Ruby, we recommend that you use the <b>Ruby+Devkit 4.0.X (x64)</b> installer.
...
Ruby can be updated to the latest patch version (e.g. from 3.4.0 to 3.4.3) by running the new installer version.
...
That is to say, a previous RubyInstaller-3.4.x installation <b>should not</b> be updated by installing RubyInstaller-4.0.x into the same directory.
This is because gems with C extensions are not compatible between ruby-3.4 and 4.0.
